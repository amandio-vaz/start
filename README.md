...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/amandio-vaz)
[![vCortex](https://img.shields.io/badge/vCortex-00ADD8?style=for-the-badge&logo=google-chrome&logoColor=white)](https://iris.gpsitservicos.com.br)
...
- **AI-Assistant**: Criador da **IRIS**, sistema descontinuado, para atendimento inteligente que integraria agentes IA autônomos, automação e observabilidade
- **AI-Apps (Era Agêntica)**: Criador do modelo de linguagem **vCortex**, onde diversos agentes especialistas autônomos, consomem dados e são treinados, com a principal finalidade em construir plataformas, com ferramentas altamente especializadas para as suas áreas. Utilizando como tecnologias principais em frontend: React, TypeScript, Vite. Principais em Backend: Node.js (ou FastAPI), Redis, MongoDB, PostgreSQL, MCP Servers, entre outras.
...
- **Stack Moderna**: Prometheus, SigNoz, Grafana, OpenTelemetry, Vector (VRL), MongoDB, TimescaleDB, ClickHouse
...
- **CI/CD Pipelines**: Automação de deploy com integração contínua e entrega contínua (GitHub Actions)
...
![Ansible](https://img.shields.io/badge/ansible-31F20?style=for-the-badge&logo=Ansible&logoColor=white)
![Apache Kafka](https://img.shields.io/badge/Apache_Kafka-231F20?style=for-the-badge&logo=apache-kafka&logoColor=white)

### **Observability & Monitoring**
![Prometheus](https://img.shields.io/badge/Prometheus-E6522C?style=for-the-badge&logo=prometheus&logoColor=white)
![OpenTelemetry](https://img.shields.io/badge/OpenTelemetry-E6522C?style=for-the-badge&logo=pOpenTelemetry&logoColor=white)
![Grafana](https://img.shields.io/badge/Grafana-F46800?style=for-the-badge&logo=grafana&logoColor=white)
![SiGnoz](https://img.shields.io/badge/Signoz-DC382D?style=for-the-badge&logo=signoz&logoColor=white)

### **AI & ML Technologies**
![OpenAI](https://img.shields.io/badge/OpenAI-412991?style=for-the-badge&logo=openai&logoColor=white)
![MCP](https://img.shields.io/badge/modelcontextprotocol-000000?style=for-the-badge&logo=modelcontextprotocol&logoColor=white)
![Gemini](https://img.shields.io/badge/googlegemini-2496ED?style=for-the-badge&logo=googlegemini&logoColor=white)
![Anthropic](https://img.shields.io/badge/Anthropic-231F20?style=for-the-badge&logo=anthropic&logoColor=white)
![Mistral](https://img.shields.io/badge/mistralai-F46800?style=for-the-badge&logo=mistralai&logoColor=white)
...
![MongoDB](https://img.shields.io/badge/MongoDB-31F20?style=for-the-badge&logo=MongoDB&logoColor=white)

---

## 🎯 Projetos em Destaque

### 🤖 **IRIS - AI System** (DESCONTINUADO)
Sistema inteligente de gestão de incidentes que revoluciona operações através de:
- Integração **Plataformas para desenvolvimento de Agentes IA autônomo + Automação Low-Code N8N + Stack de Obervabilidade** para processamento autônomo de alertas
...
### 📚 **Technical Documentation Platform (vCortex Project)**
Plataforma agêntica de documentação técnica moderna e inteligente construído com:
- **Frontend: React + TypeScript + Vite** com componentes reutilizáveis
...
### 📊 **Next-Gen NOC Architecture 2026** (NÃO CONFIRMADO)
Arquitetura completa de NOC com:
- Event-driven workflows com **Kafka** para processamento em tempo real
- Stack de observability: **Prometheus + SigNoz + Vector + OpenTelemetry**
...
- **SigNoz + OpenTelemetry** APM Full Stack integrado ao coletor universal (Protocolo OTel) de última geração
- **Vector com VRL** para processamento e roteamento de logs para o OpenTelemetry
- **ClickHouse** para analytics de alta performance
- **TimescaleDB** otimizado para séries temporais quando utilizado com PostgreSQL
...
- **GPU Infrastructure**: Avaliando **NVIDIA RTX 5090** para inferência de LLMs corporativos (VERBA NEGADA)
...
- 📧 **Email**: [amandio.vaz@gpsit.com.br](mailto:amandio.vaz@gpsit.com.br)
- 🌐 **Website**: [vcortex.xyz](https://vcortex.xyz)
- 📍 **Localização**: ![Tor](https://img.shields.io/badge/torproject-7D4698?style=for-the-badge&logo=torproject&logoColor=white)
...
![Visitor Count](https://visitor-badge.laobi.icu/badge?page_id=seu-usuario.seu-usuario)
